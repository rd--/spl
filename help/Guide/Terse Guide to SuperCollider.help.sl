...
[10, 20, 30, 40, 50].withCollectCrossed([1, 2, 3], plus:/2) = [11, 12, 13, 21, 22, 23, 31, 32, 33, 41, 42, 43, 51, 52, 53]
let x = [4, 4.5]; let y = [2, 3, 5, 6]; let z = [x, y]; z.withCollectTable(z, times:/2) = [x * [x, y], y * [x, y]]
...
[10, 20, 30, 40, 50].crossedMultiply([1, 2, 3]) = [10, 20, 30, 40, 50].withCollectCrossed([1, 2, 3], times:/2)
