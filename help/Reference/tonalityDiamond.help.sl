...
```
>>> { :i |
>>> 	i.tonalityDiamond.concatenation.nub.sort.ratios
>>> }.map([5 7])
[
	6/5 25/24 16/15 9/8 16/15 25/24;
	8/7 49/48 36/35 25/24 16/15 21/20 50/49 21/20 16/15 25/24 36/35 49/48
]
```
...
```
>>> { :i |
>>> 	let r = i.tonalityDiamond.concatenation.nub.sort ++ [2];
