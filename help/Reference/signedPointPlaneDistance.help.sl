...
```
>>> [1 2 2 -2].signedPointPlaneDistance([2 5 4])
6

>>> [2 3 -1 -6].signedPointPlaneDistance([0 0 0])
(-6 / 14.sqrt)

>>> [1 1 0 -2].signedPointPlaneDistance([-1 1 2])
2.sqrt.negated

>>> [3 4 -1 -1].signedPointPlaneDistance([1 2 3])
(7 / 26.sqrt)

>>> [5 3 1 -8].signedPointPlaneDistance([1 7 4])
(22 / 35.sqrt)
```
