...
Variance gives the unbiased estimate of variance, the dispersion of data.
	...
	[1.21 3.4 2 4.66 1.5 5.61 7.22].variance ~ 5.16122
	1:4.variance = (5 / 3)
	1:4.standardDeviation = (5 / 3).sqrt
	[134 143 131 140 145 136 131 136 143 136 133 145 147 150 150 146 137 143 132 142 145 136 144 135 141].variance = 34.04
