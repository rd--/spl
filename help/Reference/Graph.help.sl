...
in which case _vertexLabels_ is a List of _size_ labels, one for each vertex.

Edges may also be labeled,
in which case _edgeLabels_ is a List of labels, one for each edge.

_labeledVertices_ answers a List of Associations between vertices and labels,
