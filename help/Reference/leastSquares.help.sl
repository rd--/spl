...
```
>>> let m = [3.2 2.2 1.2; 2.1 7.1 8.5; 9.5 6.7 3.7];
>>> let b = [7 8 9];
>>> leastSquares(m, b)
...
```
>>> let m = [4 3 3; 2 2 1; 7 6 8; 4 0 4; 6 3 5];
>>> let b = [4 2 8 2 1];
>>> leastSquares(m, b)
...
```
>>> leastSquares([2; 1; 3; 4; 5], [1 2 3 4 5])
[0.98181]
```
...
```
>>> let h = [1.47 1.50 1.52 1.55 1.57 1.60 1.63 1.65 1.68 1.70 1.73 1.75 1.78 1.80 1.83];
>>> let w = [52.21 53.12 54.48 55.84 57.20 58.57 59.93 61.29 63.11 64.47 66.28 68.10 69.92 72.19 74.46];
>>> let m = h.collect { :each | each ^ [0 1 2] };
>>> let b = w;
>>> leastSquares(m, b)
