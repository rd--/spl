...
Find the sequence of values leading to a fixed point:
	...
	{ :x | 1 + (x / 2).floor }.fixedPointList(1000, =) = [1000 501 251 126 64 33 17 9 5 3 2 2]
...
Use a test function with a specific tolerance to resolve this:
	...
	cos:/1.fixedPointList(0.5, ~).size = 24
	cos:/1.fixedPointList(0.5) { :alpha :beta | (alpha - beta).abs < 0.1 } ~ [0.5 0.8775 0.6390 0.8027 0.6948 0.7682]
