...
```
>>> [1.4 2; 3 -6.7].gaussJordanInverse
...
```
>>> [1 2 3; 4 2 2; 5 1 7].gaussJordanInverse
[-2/7 11/42 1/21; 3/7 4/21 -5/21; 1/7 -3/14 1/7]

>>> [2 3 2; 4 9 2; 7 2 4].gaussJordanInverse
[-8/13 2/13 3/13; 1/26 3/26 -1/13; 55/52 -17/52 -3/26]

>>> [0 -3 -2; 1 -4 -2; -3 4 1].gaussJordanInverse
[4 -5 -2; 5 -6 -2; -8 9 3]

>>> [2 -1 0; -1 2 -1; 0 -1 2].gaussJordanInverse
...
```
>>> [1.2 2.5 -3.2; 0.7 -9.4 5.8; -0.2 0.3 6.4].gaussJordanInverse
[
