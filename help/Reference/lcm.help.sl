...
Lcm threads elementwise over lists:
	...
	[3 7 40].collect { :each | 12.lcm(each) } = [12 84 120]
	[3 7 40].lcm(12) = [12 84 120]
	12.lcm([3 7 40]) = [12 84 120]

Lcm of first one hundred integers:

	(1n .. 100n).lcm = 69720375229712477164533808935312303556800n

Cumulative least common multiples:

	1:9.scan(lcm:/2) = [1 2 6 12 60 60 420 840 2520]
