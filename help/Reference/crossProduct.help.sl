...
```
>>> Point(1, 2, -1).cross(Point(-1, 1, 0))
Point(1, 1, 3)

>>> Point(3.2, 4.2, 5.2).cross(Point(0.75, 0.09, 0.06))
...
```
>>> Point(1.3j1, 2, 3j-2).cross(Point(6j1, 4, 5j-7))
...
```
>>> Point(1, 2, 3).cross(Point(1, 8, 9))
Point(-6, -6, 6)

>>> Point(1, 2, 3).cross(Point(1, 4, 9))
Point(6, -6, 2)
```
