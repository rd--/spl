...
Successive integers:
	...
	{ :x | x + 1 }.nestList(0, 10) = [0 .. 10]

Growth of annually compounded capital:

	{ :x | x * 1.05}.nestList(1000, 10) ~ [1000 1050 1102.5 1157.625 1215.51 1276.28 1340.10 1407.10 1477.46 1551.33 1628.89]

Newton iterations for 2.sqrt:

	{ :x | (x + (2 / x)) / 2 }.nestList(1, 5) ~ [1 1.5 1.41667 1.41422 1.41421 1.41421]

Iterated map:

	{ :x | 4 * x * (1 - x) }.nestList(1/3, 5) = [1/3 8/9 32/81 6272/6561 7250432/43046721 1038154236987392/1853020188851841]

Iterates in the _3 n + 1_ problem:

	{ :x | x.even.if { x / 2 } { (3 * x + 1) / 2 } }.nestList(100, 20) = [100 50 25 38 19 29 44 22 11 17 26 13 20 10 5 8 4 2 1 2 1]
