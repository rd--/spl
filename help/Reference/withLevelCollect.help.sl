...
```
>>> [2, 3, 2].iota.withLevelCollect { :z :k | [0 1].includes(k).if { z.reversed } { z } }
[11 12; 9 10; 7 8;; 5 6; 3 4; 1 2]

>>> [2, 3, 2].iota.withLevelCollect { :z :k | [0 2].includes(k).if { z.reversed } { z } }
[8 7; 10 9; 12 11;; 2 1; 4 3; 6 5]

>>> [2, 3, 2].iota.withLevelCollect { :z :k | [1 2].includes(k).if { z.reversed } { z } }
[6 5; 4 3; 2 1;; 12 11; 10 9; 8 7]

>>> [2, 3, 2].iota.withLevelCollect { :z :k | [0 1 2].includes(k).if { z.reversed } { z } }
