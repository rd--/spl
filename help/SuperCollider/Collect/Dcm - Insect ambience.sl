...
(* bugs *)
let amp = 1.2, ampLagTime = 20, cutFreq = 600, nse = 0.1, nFreq = 800;
...
(* thestart (modified) *)
let amp = 0.2, ampLagTime = 5, freq = 1000, pos = 1, posLagTime = 30;
let src = {
	Hpf(
...
let amp = 0.2, lagTime = 120, freq = 240, frq = 490;
