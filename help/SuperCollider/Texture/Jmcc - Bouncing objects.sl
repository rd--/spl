...
{
	var impFreq = XLine(3 + 2.Rand0, 600, 4);
	var impAmp = XLine(0.01 + 0.09.Rand0, 0.000009, 4);
	var imp = Impulse(impFreq, 0) * impAmp;
	var exc = Decay(imp, 0.001);
	var fltFreq = { 400 + 8000.Rand0 } ! 4;
	var fltAmp = { 1.Rand0 } ! 4;
	var fltRtm = { 0.01 + 0.1.Rand0 } ! 4;
