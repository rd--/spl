...
- _Promise(aProcedure:/2)_

Answer a Promise tied to the execution of _aProcedure_,
which recieves two procedures, _resolve:/1_ and _reject:/1_, as arguments.
When _aProcedure_ runs either _resolve_ or _reject_ the answer Promise is resolved or rejected.
