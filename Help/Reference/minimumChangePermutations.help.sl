...
The permutations generated by Heap’s algorithm
in relation to their reverse colexicographic sequence,
OEIS [A280318](https://oeis.org/A280318):

~~~spl svg=B oeis=A280318
let p = 5.heapsAlgorithm;
...
![](Help/Image/minimumChangePermutations-B.svg)
