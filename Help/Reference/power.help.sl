...
_n^2-(-1^n+1)/2_,
OEIS [A085046](https://oeis.org/A085046):
...
_2^n-2_,
OEIS [A000918](https://oeis.org/A000918):
...
_2^(2^n)_,
OEIS [A001146](https://oeis.org/A001146):
...
_(10^n-1)^2/81_,
OEIS [A002477](https://oeis.org/A002477):
...
_(3^n+1)/2_,
OEIS [A007051](https://oeis.org/A007051):
...
_(7n^3+6n^2+5n)/6_
OEIS [A101165](https://oeis.org/A101165):
