...
```
>>> ([1.2 2.5 4.1 1.6 3.8 2.6 2.9] * 10).rounded.stemLeafPlot
[
	1 -> [2 6],
	2 -> [5 6 9],
	3 -> [8],
...
```
>>> [44 46 47 49 63 64 66 68 68 72 72 75 76 81 84 88 106].stemLeafPlot
[
	4 -> [4 6 7 9],
	6 -> [3 4 6 8 8],
	7 -> [2 2 5 6],
...
```
>>> let x = [
>>> 	-22 12 -28 52 39 -2 12 10 11 11 42 38 44 18 44 37 113 124 37 48
...
>>> 	34 133 45 120 30 127 31 116 146 21 23 30 10 20 21 30 0 100 110 1 20 0
>>> ];
>>> x.stemLeafPlot
[
	-2 -> [2 8],
