...
```
>>> 'abracadabra'.findPreviousOccurrenceOfStringStartingAt('ra', 5)
3

>>> 'abracadabra'.findPreviousOccurrenceOfStringStartingAt('ra', 11)
10
```
...
```
>>> 'abracadabra'.findPreviousOccurrenceOfStringStartingAt('ra', 3)
3
```
...
```
>>> 'abracadabra'.findPreviousOccurrenceOfStringStartingAt('ax', 3)
0
```
