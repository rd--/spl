...
- _overlapTextureProgram(f/0, sustainTime, transitionTime, overlap)_
...
The program below generates a simple texture,
chords are generated by frequency shifting a sine tone:
