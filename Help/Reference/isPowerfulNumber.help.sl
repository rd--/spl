...
There are an infinite number of powerful numbers,
...
The numbers of powerful numbers _≤10n_,
OEIS [A118896](http://oeis.org/A118896):
...
There are infinitely many pairs of consecutive powerful numbers,
OEIS [A060355](http://oeis.org/A060355):

```
>>> 1:1000.select { :n |
>>> 	n.isPowerfulNumber & {
>>> 		(n + 1).isPowerfulNumber
>>> 	}
>>> }
[8 288 675]
```
