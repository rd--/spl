...
Convergents to _1+√3_,
OEIS [A002605](https://oeis.org/A002605):

```
>>> 0:20.collect { :n |
>>> 	let a = n.fibonacci(2.sqrt);
>>> 	a * (2 ^ ((n - 1) / 2))
>>> }.round
[
	0 1 2 6 16 44 120 328 896 2448 6688
	18272 49920 136384 372608 1017984
	2781184 7598336 20759040 56714752
	154947584
]

>>> linearRecurrence([2 2], [0 1], 11)
[0 1 2 6 16 44 120 328 896 2448 6688]
...
[
	...
	4962558182400 15011738501760000L
]
```
