...
The main heading is the name of the entry and is written using _#-prefix_ notation.
...
- _See also_: indicates a list of related reference help files to consult
- _Guides_: indicates a list of related guides to consult
