	...
	oeisSplFunctionReferenceTable { :self |
		self.cached('oeisSplFunctionReferenceTable') {
			(
				...
				binomial: [000125 006542 027907 000127 000984 166556 109449 000332 060693],
				bitAnd: [279125],
				...
				derangements: [000166],
				differences: [049296],
				digitCount: [000120 006046 005823 005811],
				digitalRoot: [010888],
				...
				integerDigits: [062756 364024 007376 265326 117966 160855 010060 005811 014311],
				integerExponent: [001511 007814 025480],
				integerLength: [070939 061384],
				integerPartitions: [036036 080577 080576 193073],
				...
				primePi: [000720 049084],
				primesList: [000040],
				primeSignature: [036035 025487 118914],
