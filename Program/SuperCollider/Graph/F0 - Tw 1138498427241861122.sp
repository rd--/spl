/* http://twitter.com/redFrik/status/1138498427241861122 (F0) */
let f = 9.sqrt;
let b = [f, 9.999];
let d = SinOscFb(b / 99, 0).Max(0);
let t1 = Select2(SinOscFb(SinOscFb(9 / 999, 0), 0) > SinOscFb(9 / 99, 0), f, 9 / b);
let t2 = Select2(SinOscFb(9 / 99, 0) < SinOscFb(99 / 9999, 0), b / 9, f);
...
Hpf(Splay2(s3), 9).transpose.Mix * 0.5
