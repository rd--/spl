...
let phasor = Phasor(0, freq * SampleDur(), width.Minus, 1 - width, 0);
phasor = Bilin(phasor, 0, width.Minus, 1 - width, 0, -1, 1);
...
let freq = 130;
let width = LinLin(LfTri(0.1, 0), -1, 1, 0.01, 0.99);
let phasor = Phasor(0, freq * SampleDur(), width.Minus, 1 - width, width.Minus);
phasor = Bilin(phasor, 0, width.Minus, 1 - width, 0, -0.5, 1);
