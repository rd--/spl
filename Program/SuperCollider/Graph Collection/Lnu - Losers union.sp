...
Splay(
	...
	) * (LfSaw(5 / 3, 0) * (LfSaw(7 / 3 * n().-, 0).Tan)).Abs
).Tanh
...
let a = { l(0.001, 1) } ! 6;
let f = l(12, 999);
let e = Env(a, a / a.Sum / f, a.- * 9, nil, nil, 0).circle(0, 'lin').asEnvGen(1);
