...
let x = BrownNoise(2 # [0.007], 0) * (LfNoise1(ExpRand(0.125, 0.5)) * 0.6 + 0.4).Max(0);
...
let n = 6;
let exc = BrownNoise(2 # [0.007], 0) * (LfNoise1(ExpRand(0.125, 0.5)) * 0.75 + 0.25).Max(0);
...
BrownNoise(2 # [0.5], -0.49).Max(0).Times(20).Rhpf(5000, 1)
